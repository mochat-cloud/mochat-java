...
(
    ...
    name varchar(30) default '' not null comment '活码名称',
...
(
    id int unsigned auto_increment
        primary key,
    page_name varchar(10) default '' not null comment '侧边栏页面名称',
    page_flag varchar(50) default '' not null comment '侧边栏页面标识',
...
(
    ...
    wx_corpid char(18) default '' not null comment '企业微信ID',
    social_code char(18) default '' not null comment '企业代码(企业统一社会信用代码)',
    employee_secret char(43) default '' not null comment '企业通讯录secret',
...
(
    id int auto_increment comment '主键'
        primary key,
    corp_id int default 0 not null comment '企业ID',
    type varchar(50) default '' not null comment '欢迎语类型',
...
(
    ...
    icon varchar(100) default '' not null comment '图标标识',
    ...
    operate_name varchar(50) default '' not null comment '操作人姓名【mc_user.name】',
...
(
    ...
    name varchar(25) default '' not null comment '角色名称',
    remarks varchar(255) default '' not null comment '角色描述',
    status tinyint default 1 not null comment '状态【1-启动(默认)2-禁用】',
    operate_id int not null comment '操作人ID【mc_user.id】',
    operate_name varchar(50) default '' not null comment '操作人ID【mc_user.name】',
...
(
    ...
    sensitive_word_name varchar(100) not null comment '敏感词词库表名称(mc_sensitive_word.name)',
    source tinyint default 0 not null comment '触发来源【1-客户2-员工】',
    trigger_id int default 0 not null comment '触发人id',
    trigger_name varchar(50) default '' not null comment '触发人名称',
    ...
    receiver_name varchar(100) default '' not null comment '接收者名称',
...
(
    ...
    menu_name varchar(50) not null comment '菜单名称【mc_rbac_menu.name】',
    operate_id int default 0 not null comment '操作人ID【mc_user.id】',
    operate_name varchar(50) default '' not null comment '操作人姓名【mc_user.name】',
    created_at timestamp null comment '创建时间',
    updated_at timestamp default CURRENT_TIMESTAMP null comment '更新时间',
...
(
    ...
    logo varchar(100) default '' not null comment '租户Logo地址',
    login_background varchar(100) default '' not null comment '登录页背景图地址',
    url varchar(255) default '' null comment '网站地址',
    created_at timestamp default CURRENT_TIMESTAMP null comment '创建时间',
    updated_at timestamp null on update CURRENT_TIMESTAMP comment '更新时间',
    deleted_at timestamp null comment '删除时间',
    copyright varchar(100) default '' not null comment '租户版权',
...
(
    ...
    wx_external_userid varchar(64) default '' not null comment '外部联系人external_userid',
    name varchar(32) default '' not null comment '外部联系人姓名',
    nick_name varchar(50) default '' not null comment '外部联系人昵称',
    ...
    type tinyint(1) unsigned default 1 not null comment '外部联系人的类型，1表示该外部联系人是微信用户，2表示该外部联系人是企业微信用户',
    gender tinyint(1) unsigned default 0 not null comment '外部联系人性别 0-未知 1-男性 2-女性',
...
',
    state varchar(30) default '' not null comment '企业自定义的state参数，用于区分客户具体是通过哪个「联系我」添加，由企业通过创建「联系我」方式指定
',
    corp_id int(11) unsigned default 0 not null comment '企业表ID（corp.id）',
...
(
    id int(11) unsigned auto_increment
        primary key,
    wx_user_id varchar(64) default '' not null,
    contact_id int(11) unsigned default 0 not null comment '客户表id（work_contact.id）',
...
(
    id int(11) unsigned auto_increment comment '企业标签ID'
        primary key,
    wx_contact_tag_id varchar(60) default '' not null comment '微信企业标签ID',
    corp_id int(11) unsigned default 0 not null comment '企业表ID （mc_corp.id）',
...
(
    ...
    position varchar(32) default '' not null comment '职位信息',
    ...
    telephone varchar(32) default '' not null comment '座机',
    alias varchar(32) default '' not null comment '别名',
    ...
    external_position varchar(32) default '' null comment '员工对外职位',
    address varchar(50) default '' not null comment '地址',
    open_user_id char(64) default '' not null comment '全局唯一id',
...
(
    id int unsigned auto_increment
        primary key,
    corp_id int(11) unsigned not null comment '企业表ID(mc_corp.id)',
    qrcode_name varchar(30) default '' not null comment '二维码名称',
    qrcode_url varchar(100) default '' not null comment '二维码地址',
    wx_config_id varchar(50) default '' not null comment '二维码凭证',
