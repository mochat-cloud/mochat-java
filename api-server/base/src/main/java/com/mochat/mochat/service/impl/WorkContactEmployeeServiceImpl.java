...
public class WorkContactEmployeeServiceImpl extends ServiceImpl<WorkContactEmployeeMapper, WorkContactEmployeeEntity> implements IWorkContactEmployeeService {
    ...
    @Override
    public Long getCountOfContactByCorpIdStartTimeEndTime(Integer corpId, String startTime, String endTime) {
    ...
    @Override
    public Long getCountOfLossContactByCorpIdStartTimeEndTime(Integer corpId, String startTime, String endTime) {
        return lambdaQuery().eq(WorkContactEmployeeEntity::getCorpId, corpId)
                .ge(WorkContactEmployeeEntity::getCreateTime, startTime)
                .le(WorkContactEmployeeEntity::getCreateTime, endTime)
