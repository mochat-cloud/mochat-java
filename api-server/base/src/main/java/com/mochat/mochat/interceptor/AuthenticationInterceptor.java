...
import com.mochat.mochat.common.annotion.SkipPermissionVerity;
import com.mochat.mochat.common.annotion.SkipTokenVerity;
...
public class AuthenticationInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        if (method.isAnnotationPresent(SkipTokenVerity.class)) {
            return true;
        }
        ...
        if (method.isAnnotationPresent(SkipPermissionVerity.class)) {
