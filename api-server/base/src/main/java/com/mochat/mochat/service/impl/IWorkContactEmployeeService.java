...
public interface IWorkContactEmployeeService extends IService<WorkContactEmployeeEntity> {
    ...
    Long getCountOfContactByCorpIdStartTimeEndTime(Integer corpId, String startTime, String endTime);

    Long getCountOfLossContactByCorpIdStartTimeEndTime(Integer corpId, String startTime, String endTime);
}
