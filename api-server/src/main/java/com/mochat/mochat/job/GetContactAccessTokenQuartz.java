...
/**
 * @author zhaojinjian
 * @ClassName GetContactAccessTokenQuartz.java
 * @Description TODO
...
@EnableAsync
public class GetContactAccessTokenQuartz {
    ...
    public void  get_access_token() {
        ...
        String appsecret =  Const.CONTACT_SECRET;
        ...
        if (jsonObject.getString("access_token") != null) {
            ...
            try {
                ...
                map.put("contact_access_token", jsonObject.getString("access_token"));
