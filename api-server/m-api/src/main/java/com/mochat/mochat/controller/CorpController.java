...
public class CorpController {
    ...
    public ApiRespVO getCorpList(String corpName, ReqPageDto requestPage, @RequestAttribute ReqPerEnum permission) {
        return ApiRespUtils.okPage(corpServiceImpl.getCorpPageList(corpName, requestPage, permission));
    }
